...
class Rs {
  ...
  private static function loadUis() {
    ...
    craft.set("leaf", Assets.getBitmapData("img/craft/ingredients/leaf.png"));
    craft.set("plank", Assets.getBitmapData("img/craft/ingredients/plank.png"));
    craft.set("stone", Assets.getBitmapData("img/craft/ingredients/stone.png"));
    craft.set("rope", Assets.getBitmapData("img/craft/ingredients/rope.png"));
    craft.set("sail", Assets.getBitmapData("img/craft/ingredients/sail.png"));
    craft.set("wood", Assets.getBitmapData("img/craft/ingredients/wood.png"));
    craft.set("fruit", Assets.getBitmapData("img/craft/ingredients/fruit.png"));
  }
