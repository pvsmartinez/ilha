...
#define INCLUDED_lime_net_URLVariables

#ifndef HXCPP_H
#include <hxcpp.h>
#endif

HX_DECLARE_CLASS2(lime,net,URLVariables)
namespace lime{
namespace net{
...
class HXCPP_CLASS_ATTRIBUTES  URLVariables_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="lime.net.URLVariables")
...
#endif /* INCLUDED_lime_net_URLVariables */ 
