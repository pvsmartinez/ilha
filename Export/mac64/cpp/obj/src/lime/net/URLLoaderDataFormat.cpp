...
::lime::net::URLLoaderDataFormat URLLoaderDataFormat_obj::BINARY;

::lime::net::URLLoaderDataFormat URLLoaderDataFormat_obj::TEXT;

::lime::net::URLLoaderDataFormat URLLoaderDataFormat_obj::VARIABLES;
...
hx::Static(__mClass) = hx::RegisterClass(HX_HCSTRING("lime.net.URLLoaderDataFormat","\x79","\xdd","\x71","\x33"), hx::TCanCast< URLLoaderDataFormat_obj >,sStaticFields,sMemberFields,
