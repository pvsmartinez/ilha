...
hx::Static(__mClass) = hx::RegisterClass(HX_HCSTRING("openfl.display.CapsStyle","\xa6","\x8f","\xda","\x2f"), hx::TCanCast< CapsStyle_obj >,sStaticFields,sMemberFields,
...
{
hx::Static(NONE) = hx::CreateEnum< CapsStyle_obj >(HX_HCSTRING("NONE","\xb8","\xda","\xca","\x33"),0);
hx::Static(ROUND) = hx::CreateEnum< CapsStyle_obj >(HX_HCSTRING("ROUND","\x2e","\x30","\x54","\x6b"),1);
