...
HX_STACK_ARG(gl,"gl")
{
	...
	HX_STACK_LINE(14)
	::String tmp3 = (HX_HCSTRING("attribute vec4 ","\xbc","\x45","\xff","\xbe") + HX_HCSTRING("aColor","\x42","\xe1","\x27","\xa6"));		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(14)
	::String tmp4 = (tmp3 + HX_HCSTRING(";","\x3b","\x00","\x00","\x00"));		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(16)
	::String tmp5 = (HX_HCSTRING("uniform mat3 ","\x41","\xcb","\x75","\x0c") + HX_HCSTRING("uTranslationMatrix","\xdd","\x91","\xa9","\x55"));		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(16)
	...
	HX_STACK_LINE(18)
	::String tmp9 = (HX_HCSTRING("uniform vec4 ","\xd4","\xf8","\xa8","\x3d") + HX_HCSTRING("uColorMultiplier","\xcf","\xe9","\x0f","\xba"));		HX_STACK_VAR(tmp9,"tmp9");
	HX_STACK_LINE(18)
	::String tmp10 = (tmp9 + HX_HCSTRING(";","\x3b","\x00","\x00","\x00"));		HX_STACK_VAR(tmp10,"tmp10");
	HX_STACK_LINE(19)
	::String tmp11 = (HX_HCSTRING("uniform vec4 ","\xd4","\xf8","\xa8","\x3d") + HX_HCSTRING("uColorOffset","\xe1","\xda","\x17","\x0b"));		HX_STACK_VAR(tmp11,"tmp11");
	HX_STACK_LINE(19)
	::String tmp12 = (tmp11 + HX_HCSTRING(";","\x3b","\x00","\x00","\x00"));		HX_STACK_VAR(tmp12,"tmp12");
	HX_STACK_LINE(20)
	::String tmp13 = (HX_HCSTRING("uniform float ","\x70","\x08","\x5a","\x60") + HX_HCSTRING("uAlpha","\xa9","\x4e","\x85","\x7c"));		HX_STACK_VAR(tmp13,"tmp13");
	HX_STACK_LINE(20)
	...
	HX_STACK_LINE(35)
	::String tmp21 = (HX_HCSTRING("   vColor = colorTransform(","\xe9","\x4a","\x56","\xf6") + HX_HCSTRING("aColor","\x42","\xe1","\x27","\xa6"));		HX_STACK_VAR(tmp21,"tmp21");
	HX_STACK_LINE(35)
