...
Dynamic Uncompress_obj::execute( ::haxe::io::Bytes src,int srcPos,::haxe::io::Bytes dst,int dstPos){
	HX_STACK_FRAME("haxe.zip.Uncompress","execute",0xb3589a97,"haxe.zip.Uncompress.execute","/usr/local/lib/haxe/std/cpp/_std/haxe/zip/Uncompress.hx",32,0x2e2bbf2e)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxe.zip.Uncompress","close",0x4cc86b9a,"haxe.zip.Uncompress.close","/usr/local/lib/haxe/std/cpp/_std/haxe/zip/Uncompress.hx",40,0x2e2bbf2e)
		HX_STACK_THIS(this)
		HX_STACK_LINE(41)
		Dynamic tmp = this->s;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(41)
