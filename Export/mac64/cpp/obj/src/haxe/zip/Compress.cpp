...
Dynamic Compress_obj::execute( ::haxe::io::Bytes src,int srcPos,::haxe::io::Bytes dst,int dstPos){
	HX_STACK_FRAME("haxe.zip.Compress","execute",0xd015e2fe,"haxe.zip.Compress.execute","/usr/local/lib/haxe/std/cpp/_std/haxe/zip/Compress.hx",33,0x9f8c8027)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxe.zip.Compress","close",0x6942fc41,"haxe.zip.Compress.close","/usr/local/lib/haxe/std/cpp/_std/haxe/zip/Compress.hx",41,0x9f8c8027)
		HX_STACK_THIS(this)
		HX_STACK_LINE(42)
		Dynamic tmp = this->s;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(42)
