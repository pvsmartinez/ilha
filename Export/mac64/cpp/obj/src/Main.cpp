...
HX_STACK_THIS(this)
{
	...
	super::__construct();
	HX_STACK_LINE(11)
	::Game tmp = ::Game_obj::__new();		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(11)
	this->game = tmp;
	HX_STACK_LINE(12)
	::Game tmp1 = this->game;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(12)
	this->addChild(tmp1);
}
;
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::Game*/ ,(int)offsetof(Main_obj,game),HX_HCSTRING("game","\xf2","\xf3","\x5e","\x44")},
	{ hx::fsUnknown, 0, null()}
};
